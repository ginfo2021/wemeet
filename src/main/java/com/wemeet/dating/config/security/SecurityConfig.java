...
import com.wemeet.dating.config.security.filter.AuthenticationFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Autowired
    private WeMeetAuthenticationEntryPoint weMeetAuthenticationEntryPoint;
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.csrf().disable()
                ...
                .exceptionHandling().authenticationEntryPoint(weMeetAuthenticationEntryPoint)
                .and()
